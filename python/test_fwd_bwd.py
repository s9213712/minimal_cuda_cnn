#!/usr/bin/env python3
"""Test forward + backward with small batch"""
import ctypes
import numpy as np
...
print("Pool backward done, conv grad stats:", h_conv_grad.min(), h_conv_grad.max())

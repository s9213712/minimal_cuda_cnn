#!/usr/bin/env python3
"""Training with moderate weights - clean version"""
import ctypes
import numpy as np
import os
import time
...
def train():
    ...
    print("=== Training with Moderate Weights ===")
    ...
    for epoch in range(EPOCHS):
        ...
        for batch_idx in range(N_TRAIN // BATCH):
            ...
            # FC -> Pool gradient using original weights
            ...
            # Pool backward: d_pool_grad -> d_conv_grad
            ...
            # Conv backward: compute weight gradients
            ...
            # Clip conv gradient before update

...
def train():
    ...
    print("=== Training with Stable Weights ===")
    ...
    # Use SMALL stable weights instead of Xavier
    np.random.seed(42)
    ...
    print(f"Weights: conv std=0.001, fc std=0.001")

...
def train():
    ...
    print("=== Training with Bigger Weights ===")
    ...
    print(f"Weights: conv std=0.3, fc std=0.1")
    ...
    for epoch in range(EPOCHS):
        ...
        for batch_idx in range(N_TRAIN // BATCH):
            ...
            # Leaky ReLU backward
            bridge.lib.leaky_relu_backward(d_conv, d_conv_grad, c_float(LEAKY_ALPHA), OC * BATCH * outH * outW)

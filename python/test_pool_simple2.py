#!/usr/bin/env python3
"""Test pool backward with simple data"""
import ctypes
import numpy as np
...
print("\nPool output (shape", h_output.shape, "):")
print(h_output[0, 0])

# Grad out = ones for all positions
...
print("\nExpected: 1 at [1,1]=6, [1,3]=8, [3,1]=14, [3,3]=16, zeros elsewhere")
